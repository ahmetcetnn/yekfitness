...
function Login() {
  ...
  <form onSubmit={handleLogin}>
        <div className="justify-center text-center items-center flex flex-col text-black">
          ...
          <br></br>
            <input
              className='border-solid border border-x-gray-900 w-96 h-12 mt-56 rounded-md' type="email" 
          ...
          <button className='border-solid border cursor-pointer bg-white text-slate-800 mt-2 w-96 h-12 rounded-md'
           disabled={!email || !password} type="submit"> Log In</button>
            ...
            <p >Dont you have an account? <Link to="/register" className='hover:text-sky-700'> Sign Up</Link></p>
      </div>
      </form>
      </div>
